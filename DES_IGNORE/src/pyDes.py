...
def encrypt(key, message):
    DES = triple_des(key, pad=None, padmode=PAD_PKCS5)
...
if __name__ == '__main__':
    ...
    if 'encrypt'.startswith(input_file):
        output_file = sys.argv[2]
        encryption_key = sys.argv[3]
        write(output_file, encrypt(encryption_key, text))
    elif 'decrypt'.startswith(input_file):
        output_file = sys.argv[2]
        encryption_key = sys.argv[3]
        write(output_file, decrypt(encryption_key, text))
    else:
